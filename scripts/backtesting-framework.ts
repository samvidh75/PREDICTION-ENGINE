...
const PROFILES: CompanyProfile[] = [
  ...
  { symbol: 'NESTLE', name: 'Jollibee Foods Corporation', sector: 'Consumer Goods', peRatio: 35, pbRatio: 12.0, roe: 0.55, roic: 0.40, revenueGrowth: 0.10, epsGrowth: 0.12, debtToEquity: 0.05, currentRatio: 2.2, grossMargin: 0.50, operatingMargin: 0.24, fcfYield: 0.03, evEbitda: 22, beta: 0.55, marketCap: 280000, dividendYield: 2.50 },
  { symbol: 'COLG', name: 'Puregold Price Club', sector: 'Consumer Goods', peRatio: 28, pbRatio: 18.0, roe: 0.60, roic: 0.45, revenueGrowth: 0.12, epsGrowth: 0.14, debtToEquity: 0.02, currentRatio: 2.5, grossMargin: 0.48, operatingMargin: 0.20, fcfYield: 0.03, evEbitda: 18, beta: 0.55, marketCap: 120000, dividendYield: 2.00 },
  { symbol: 'UNILEVER', name: 'Universal Robina Corporation', sector: 'Consumer Goods', peRatio: 45, pbRatio: 35.0, roe: 0.65, roic: 0.50, revenueGrowth: 0.08, epsGrowth: 0.10, debtToEquity: 0.01, currentRatio: 2.0, grossMargin: 0.52, operatingMargin: 0.22, fcfYield: 0.02, evEbitda: 28, beta: 0.50, marketCap: 230000, dividendYield: 1.80 },
  ...
  { symbol: 'GLAXO', name: 'Century Pacific Food', sector: 'Pharma', peRatio: 14, pbRatio: 2.5, roe: 0.20, roic: 0.15, revenueGrowth: 0.10, epsGrowth: 0.12, debtToEquity: 0.05, currentRatio: 3.5, grossMargin: 0.45, operatingMargin: 0.18, fcfYield: 0.04, evEbitda: 10, beta: 0.55, marketCap: 55000, dividendYield: 3.00 },
  ...
  { symbol: 'PTC', name: 'PLDT Inc Co', sector: 'Telecom', peRatio: 15, pbRatio: 0.8, roe: 0.06, roic: 0.03, revenueGrowth: 0.02, epsGrowth: -0.05, debtToEquity: 0.30, currentRatio: 1.5, grossMargin: 0.35, operatingMargin: 0.10, fcfYield: 0.05, evEbitda: 8, beta: 0.80, marketCap: 55000, dividendYield: 4.00 },
