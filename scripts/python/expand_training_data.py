...
for better coverage of greetings, stock questions, and SEC-compliant responses.
"""
...
TICKERS = ["BDO", "JFC", "BPI", "SM", "MBT", "URC",
           ...
           "ALI", "NTPC", "POWERGRID", "M&M", "ULTRACEMCO", "RLC",
           "MEG", "AP", "JSWSTEEL", "EMI", "NESTLEIND",
           "BAJAJFINSV", "INDUSINDBK", "TECHM", "DIVISLAB", "DRREDDY",
           "BRITANNIA", "EICHERMOT", "COALINDIA", "BPCL", "IOC", "ACEN",
           "GRASIM", "SMPH", "HINDALCO", "CIPLA", "HEROMOTOCO"]
...
SECTORS = {
    ...
    "AEV": "NBFC", "MARUTI": "Automobile",
    "TITAN": "Retail", "MONDE": "Pharma",
    "WIPRO": "IT Services", "ALI": "Conglomerate",
    "NTPC": "Power", "POWERGRID": "Power",
    "M&M": "Automobile", "ULTRACEMCO": "Cement",
    "RLC": "IT Services", "MEG": "Automobile",
    "AP": "Metals & Mining", "JSWSTEEL": "Metals & Mining",
    "EMI": "Consumer Goods", "NESTLEIND": "FMCG",
    ...
    "ACEN": "Oil & Gas", "GRASIM": "Cement",
    "SMPH": "Infrastructure", "HINDALCO": "Metals & Mining",
    ...
    records.append({
        "messages": [
            ...
            {"role": "assistant", "content": (
                f"{ticker} operates in the {sector} sector and is listed on PSE/PSE. "
                ...
                f"detailed analysis, check the {ticker} stock page on StockStory PH. "
...
financial_terms = {
    ...
    "Current ratio": "Current Ratio measures a company's ability to pay short-term obligations: Current Assets ÷ Current Liabilities. A ratio above 1 means current assets exceed liabilities. Below 1 could signal liquidity concerns. For PSE-listed companies, 1.5-2 is generally healthy." ,
    ...
    "Net profit margin": "Net Profit Margin is the percentage of revenue that becomes actual profit after all expenses, including taxes and interest. It's the bottom-line efficiency measure. A 15-20% margin is generally good for PSE-listed companies." ,
    ...
    "Face value": "Face Value (or par value) is the nominal value of a share as stated in the company's charter. For most PSE-listed stocks, it's ₱1, ₱2, ₱5, or ₱10. It's largely a historical concept and doesn't reflect market value." ,
...
greetings = [
    ("Hello StockEX", "Hello! I'm StockEX, your PSE-listed equity research assistant. Ready to dive into some stock analysis?"),
    ("Hi StockEX", "Hi there! How can I help with your Philippine stock market research today?"),
    ("Hey StockEX", "Hey! What stock or market topic are we researching today?"),
    ("StockEX", "That's me! StockEX — your Philippine stock market research buddy. What can I help you with?"),
    ("Hi", "Hi! Welcome to StockEX. Ask me about any PSE-listed stock, financial concept, or market trend."),
    ("Hello", "Hello! I'd love to help you research PSE-listed equities. Where would you like to start?"),
    ("Hey", "Hey! StockEX here. Ready when you are for some Philippine stock market research!"),
    ("Hi there", "Hi there! I'm your go-to assistant for Philippine stock market research. What's on your mind?"),
...
refusals = [
    ("What will be the price of BDO tomorrow?", "I can't predict stock prices — nobody can reliably. Price movements depend on countless factors including market sentiment, global news, company results, and institutional activity. Instead of predictions, I recommend focusing on company fundamentals and long-term trends. [SEC DISCLAIMER: Not investment advice.]"),
    ("Give me sure shot multibagger stocks", "I don't recommend specific stocks, and the term 'sure shot multibagger' is a red flag — no investment is guaranteed. What I can do is share research frameworks for identifying well-managed companies with strong growth potential. Look for consistent revenue growth, healthy margins, low debt, and good corporate governance. [SEC DISCLAIMER: Educational content only.]"),
    ...
    ("Can you hack the stock market", "I can't and won't help with anything illegal or unethical. The stock market functions on rules and regulations enforced by SEC. Focus on learning fundamental and technical analysis instead — that's the legitimate path to informed investing."),
]
...
thanks = [
    ...
    ("Thank you so much, very helpful", "You're very welcome! That's what I'm here for. Any other questions about PSE-listed stocks?"),
    ...
    ("Great thanks", "You're welcome! Always happy to assist with PSE-listed equity research."),
    ("Ok thanks bye", "Goodbye! Remember to do your own research and consult a SEC-registered advisor before investing. Happy investing!"),
...
misc_conv = [
    ("What does SEC registered mean?", "SEC registration means an individual or firm is authorised by the Securities and Exchange Board of India to provide investment advisory services. They must meet qualification standards, follow code of conduct, and maintain transparency. I'm not SEC-registered, which is why I provide educational research rather than personalised advice."),
    ...
    ("What is a good P/E ratio for PSE-listed stocks?", "There's no single 'good' P/E — it varies by sector. NIFTY 50 historically trades at 15-25x P/E. IT stocks often trade at 25-35x due to higher growth. Banking stocks at 15-20x. FMCG at 40-60x due to stability. Compare a company's P/E with its sector average and its own historical range."),
    ("What is the difference between PSE and PSE?", "PSE (National Stock Exchange) and PSE (Bombay Stock Exchange) are India's two major stock exchanges. PSE has higher trading volume (~80% of all trades) and is known for its electronic trading system. PSE is older (est. 1875) and has more listed companies. Most stocks are listed on both. NIFTY is PSE's index, SENSEX is PSE's."),
