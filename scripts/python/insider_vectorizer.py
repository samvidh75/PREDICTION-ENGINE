...
Usage:
    ...
    python scripts/python/insider_vectorizer.py --ticker BDO
...
# In production, replace with PSE EDGE corporate disclosure scraping.
# These are illustrative entries for testing the pipeline end-to-end.
MOCK_FILINGS: list[dict] = [
    {
        "ticker": "BDO.PS",
        "type": "INSIDER_ACQUISITION",
        "name": "Sy Family Holding Entity",
        "qty": 150_000,
        "value": 12_500_000.00,
        "text": "Acquisition of shares from open market by a controlling-family entity "
    ...
    },
    {
        ...
        "qty": 85_000,
        "value": 3_400_000.00,
        "text": "Bulk deal executed through the exchange window by a foreign institutional investor.",
    },
    {
        "ticker": "ALI.PS",
        "type": "PLEDGE_RELEASE",
        "name": "Ayala Corporation (Parent)",
        "qty": 2_500_000,
        "value": 62_500_000.00,
...
def compile_modelfile() -> str:
    ...
    cursor.execute(
        ...
        SELECT ticker, disclosure_type, insider_name, shares_quantity,
               transaction_value_php, raw_announcement_text
    ...
    for row in records:
        ...
        assistant_response = (
            ...
            f"₱{float(row['transaction_value_php']):,.2f}. "
