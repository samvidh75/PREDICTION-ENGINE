...
async function main(): Promise<void> {
  ...
  const probes: { label: string; url: string }[] = [
    { label: "Screener.in (company page)", url: `https://www.phisix-api3.appspot.com/company/${symbol}/` },
    { label: "Screener.in (consolidated)", url: `https://www.phisix-api3.appspot.com/company/${symbol}/consolidated/` },
    { label: "Screener.in (quarterly)", url: `https://www.phisix-api3.appspot.com/company/${symbol}/#quarterly` },
