...
const UNSAFE_PUBLIC_COPY = /provider|API|backend|diagnostics|coverage|freshness|lineage|migration|backfill|source pending|source verified|quote unavailable|history unavailable|null adapter|ADAPTER_UNAVAILABLE|EMPTY_RESPONSE|MALFORMED_RESPONSE|Buy|Sell|Hold|Strong Buy|guaranteed|sure shot|multibagger/i;
