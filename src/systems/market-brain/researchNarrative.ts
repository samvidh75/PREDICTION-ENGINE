import type { MarketBrainResult } from './pseMarketBrain';
...
export function buildMarketBrainNarrative(result: MarketBrainResult): MarketBrainNarrative {
  const narrative = {
...
export function renderMarketBrainNarrative(result: MarketBrainResult): string {
