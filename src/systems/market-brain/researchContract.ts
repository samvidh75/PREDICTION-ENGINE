...
import type { FactorScore, MarketBrainResult, MarketDataDomain } from './pseMarketBrain';
...
export interface MarketBrainResearchView {
  symbol: string;
  companyName: string;
  state: MarketBrainResult['researchState'];
...
const buildEvidenceReview = (result: MarketBrainResult): MarketBrainEvidenceReviewView => {
...
const buildFactorViews = (result: MarketBrainResult): MarketBrainFactorView[] => [
  {
...
export function toMarketBrainResearchView(result: MarketBrainResult): MarketBrainResearchView {
