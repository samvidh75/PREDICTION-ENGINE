...
export interface PSEEquityFundamentals {
  peRatio?: number | null;
  pbRatio?: number | null;
...
export interface PSEEquityTechnicals {
...
export interface PSEEquityOwnership {
...
export interface PSEEquityPacket {
  symbol: string;
  companyName: string;
  sector?: string | null;
  industry?: string | null;
  asOf: string;
  fundamentals?: PSEEquityFundamentals;
  technicals?: PSEEquityTechnicals;
  ownership?: PSEEquityOwnership;
...
function scoreQuality(fin?: PSEEquityFundamentals): FactorScore {
  const score = average([
...
function scoreGrowth(fin?: PSEEquityFundamentals): FactorScore {
  const score = average([
...
function scoreValuation(fin?: PSEEquityFundamentals): FactorScore {
  const score = average([
...
function scoreStability(fin?: PSEEquityFundamentals, tech?: PSEEquityTechnicals): FactorScore {
...
function scoreMomentum(tech?: PSEEquityTechnicals): FactorScore {
  const score = average([
...
function scoreRisk(fin?: PSEEquityFundamentals, tech?: PSEEquityTechnicals, own?: PSEEquityOwnership): FactorScore {
  const score = average([
...
function scoreOwnership(own?: PSEEquityOwnership): FactorScore {
  const score = average([
...
export function evaluatePSEEquity(packet: PSEEquityPacket): MarketBrainResult {
