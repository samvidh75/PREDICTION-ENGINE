...
import type { PSEExchange } from '../symbols/PSESymbol';

// ---------------------------------------------------------------------------
// Contract
// ---------------------------------------------------------------------------

export interface PSEEodCandle {
  ...
  /** Opening price in PHP (adjusted for corporate actions). */
  readonly open: number;

  /** Highest price in PHP. */
  readonly high: number;

  /** Lowest price in PHP. */
  readonly low: number;

  /** Closing price in PHP (adjusted for corporate actions). */
  ...
  /** Dividend amount in PHP per share, if any (0 = no dividend). */
 ...
 */
export function validateEodCandleBatch(candles: PSEEodCandle[]): EodCandleQuality[] {
