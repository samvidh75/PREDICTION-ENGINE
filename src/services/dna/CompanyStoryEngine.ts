...
export class CompanyStoryEngine {
  public static generate(stock: RegisteredStock): CompanyStory {
    ...
    const whatItDoes = `${stock.companyName} provides high-capacity engineering and technical operations in the PSX market, specializing in the ${stock.sector} sector.`;
