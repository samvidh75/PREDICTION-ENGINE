...
const ENTITIES: DiscoveryEntity[] = [
  // ===== Sectors =====
  {
    ...
    keywords: ["bank", "banking", "financials", "credit", "payments", "lending", "institutional"],
  ...
  },
  {
    ...
    keywords: ["it", "software", "tech", "services", "enterprise", "momentum"],
  ...
  },
  {
    ...
    keywords: ["energy", "oil", "refinery", "mining", "cyclical", "margins", "sector"],
  ...
  },
  {
    ...
    keywords: ["defense", "expansion", "cyclical", "institutional"],
  ...
  },
  {
    ...
    keywords: ["institutional", "foreign investor", "domestic institutional", "selective", "block", "accumulation", "participation"],
