...
export class ProviderRegistry {
  ...
  /**
   * Get quote with fallback chain via PSE-focused providers.
   * Primary: Yahoo Finance (PSE suffix)
   * Fallback: PHISIX API (historical), then ProviderCoordinator
   */
  ...
  /**
   * Get fundamentals with PSE-focused fallback chain:
   * 1. ProviderCoordinator (EODHD → Twelve Data)
   * 2. Trendlyne for additional fields (best-effort)
   */
