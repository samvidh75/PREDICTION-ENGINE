 ...
 * PSE-focused: Yahoo Finance, PHISIX, EODHD, Twelve Data
 */
export const DEFAULT_BUDGETS: Record<string, ProviderBudgetConfig> = {
  phisix: { provider: 'phisix', perMinute: 60, perDay: 1000, burst: 10, maxConcurrent: 3, cooldownMs: 30_000 },
  yahoo: { provider: 'yahoo', perMinute: 100, perDay: 2000, burst: 20, maxConcurrent: 10, cooldownMs: 30_000 },
  eodhd: { provider: 'eodhd', perMinute: 60, perDay: 500, burst: 10, maxConcurrent: 3, cooldownMs: 30_000 },
  twelvedata: { provider: 'twelvedata', perMinute: 60, perDay: 500, burst: 8, maxConcurrent: 3, cooldownMs: 30_000 },
};
