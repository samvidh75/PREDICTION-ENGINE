...
const DEFAULT_MEMORY: MemoryData = {
  savedCompanies: ["BDO", "ALI"],
  savedSectors: ["Banking", "Property"],
  savedStories: [
    { ticker: "BDO", title: "BDO Unibank Expansion Catalyst", addedAt: "Yesterday" }
  ],
  savedInsights: [
    { id: "i1", title: "ALI Momentum Breakout Confirmations", addedAt: "2 days ago" }
  ],
  savedSearches: ["BDO", "BPI", "ALI"],
  recentActivity: [
    { action: "Logged in from Chrome", timestamp: "10 mins ago" },
    { action: "Updated Portfolio Weights", timestamp: "30 mins ago" },
    { action: "Added ALI to Property Watchlist", timestamp: "Yesterday" }
  ],
  preferences: {
    favouredSectors: ["Banking", "Property"],
    avoidedSectors: [],
    style: 'growth',
