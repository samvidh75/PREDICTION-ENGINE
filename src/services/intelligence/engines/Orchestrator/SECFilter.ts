 ...
 * SEC (Securities and Exchange Commission, Philippines) regulations for
...
export class SECFilter {
  ...
  static generateDisclaimer(): string {
    return [
      ...
      'Please consult an SEC-registered investment adviser before making any investment decisions.',
