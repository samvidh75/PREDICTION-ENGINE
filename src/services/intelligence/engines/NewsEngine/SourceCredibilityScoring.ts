...
const HIGH_CREDIBILITY_SOURCES = [
  'reuters', 'bloomberg', 'businessworld', 'mint', 'business mirror',
  'rappler', 'cnbc', 'livemint', 'financial express', 'business line',
  'gmanews', 'zee business', 'et now', 'bq prime', 'morgan stanley',
  'jp morgan', 'goldman sachs', 'credit suisse', 'nomura', 'clsa',
  'col financial', 'bpi securities', 'ab capital', 'china bank',
  'ab capital', 'pse edge', 'care ratings', 'philratings',
];

const MEDIUM_CREDIBILITY_SOURCES = [
  'yahoo', 'google', 'msn', 'philstar', 'philippine star', 'philippine daily inquirer',
  'manila bulletin', 'firstpost', 'news18', 'abp', 'republic', 'times now',
