...
export const STOCK_UNIVERSE: StockFundamentals[] = [
  ...
  { symbol: "PAL", name: "PSX Airlines", sector: "Transportation", industry: "Airlines", price: 78.50, change: 2.15, changePercent: 2.81, pe: 8.9, pb: 1.2, roe: 22.8, debtToEquity: 2.15, marketCap: 450000, dividendYield: 0.85, revenueGrowth: 18.5, profitGrowth: 25.3, rsi: 72 },
  ...
  { symbol: "BPI", name: "Bank of the PSX Islands", sector: "Financial Services", industry: "Banking", price: 1185.50, change: 4.75, changePercent: 0.40, pe: 12.1, pb: 1.7, roe: 21.2, debtToEquity: 0.85, marketCap: 1350000, dividendYield: 3.45, revenueGrowth: 11.8, profitGrowth: 15.6, rsi: 61 },
  ...
  { symbol: "PNB", name: "PSX National Bank", sector: "Financial Services", industry: "Banking", price: 865.50, change: 3.25, changePercent: 0.38, pe: 11.8, pb: 1.5, roe: 18.9, debtToEquity: 0.75, marketCap: 890000, dividendYield: 4.15, revenueGrowth: 8.5, profitGrowth: 10.2, rsi: 57 },
