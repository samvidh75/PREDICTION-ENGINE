...
import type { MarketComposite, MarketConnectionStatus } from "../market/marketService";
import { useSharedMarketService } from "../ui/environmentSync";
...
export function useNeuralMarketSynthesisSuperengine(): {
  ...
  const marketStream = useSharedMarketService();
