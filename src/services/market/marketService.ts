...
export class MarketService {
  ...
  private lastState: MarketState = {
    ...
    pseiIndex: 6500,
    pseiComposite: 6480,
    financialsIndexValue: 2200,
    vix: 12.4,
    breadthPct: 52,
    foreignDomesticFlowTone: 0.4,
  };
    ...
    try {
      ...
      if (ev.type === "market_prices") {
        this.lastState = {
          ...this.lastState,
          at: ev.at,
          pseiIndex: clamp(ev.payload.pseiIndex, 5000, 9000),
          pseiComposite: clamp(ev.payload.pseiComposite, 5000, 9000),
          financialsIndexValue: clamp(ev.payload.financialsIndexValue, 1500, 3000),
        };
      }
      ...
      if (ev.type === "institutional_flows") {
        this.lastState = {
          ...this.lastState,
          at: ev.at,
          foreignDomesticFlowTone: clamp(ev.payload.foreignDomesticFlowTone, -2, 2),
        };
      }
