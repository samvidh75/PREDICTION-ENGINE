...
export default function AITestPage() {
  ...
  const [stockQuery, setStockQuery] = useState('Analyze BPI');
          ...
          >
            <div>
              ...
              <input
                ...
                placeholder="E.g., Analyze BPI, Best stocks to buy, Market update..."
                style={{
                  width: '100%',
                  padding: space[3],
                  borderRadius: '8px',
              ...
              <div style={{ marginTop: space[2], fontSize: '11px', color: colors.body }}>
                Try: "Analyze BPI", "Best stocks to buy", "Market update", "Explain P/E ratio"
              </div>
            </div>
