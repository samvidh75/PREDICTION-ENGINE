...
const SECTIONS = [
  {
    ...
    content: "StockEX is a structured equity research platform. We provide scorecards, theses, risk assessments, scenario analysis, and peer comparisons for listed PSE equities."
  },
  {
    id: "what-we-are-not",
