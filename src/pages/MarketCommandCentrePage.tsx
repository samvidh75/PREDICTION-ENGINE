      ...
      state === "ELEVATED_RISK"
        ...
        : state === "MOMENTUM_WEAKENING"
          ? {
              ...
              institutional: "Large-investor participation remains steady and selective.",
    ...
    <div className="relative min-h-screen overflow-hidden bg-[#0f0f0f]">
      ...
      <section className="relative z-[12] px-6 sm:px-[72px] pb-12">
        <div className="mx-auto max-w-[1680px] mb-6 flex items-end justify-between gap-4">
          <div>
            <div className="text-[12px] uppercase tracking-[0.18em] text-white/70">Live Signal Matrix</div>
            <div className="mt-3 text-[22px] font-medium text-white/92">Structured market indicators</div>
          </div>
      ...
      <section className="relative z-[12] px-6 sm:px-[72px] pb-20">
        <div className="mx-auto max-w-[1680px] mb-6 flex items-end justify-between gap-4">
          <div>
            ...
            <div className="mt-3 text-[22px] font-medium text-white/92">calm institutional tracking</div>
          </div>
