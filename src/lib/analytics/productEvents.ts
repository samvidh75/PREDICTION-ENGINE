export const PRODUCT_EVENTS = {
  ...
  COMPARE_SHARE_OPENED: "compare_share_opened",
...
export const PRODUCT_EVENT_LABELS: Record<ProductEvent, string> = {
  ...
  compare_share_opened: "Comparison share recap opened",
...
export const PRODUCT_EVENT_DESCRIPTIONS: Record<ProductEvent, string> = {
  ...
  compare_share_opened: "User opened the comparison recap share sheet",
