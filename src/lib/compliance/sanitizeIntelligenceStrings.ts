...
export function sanitizeNeuralMarketSynthesisStrings(synthesis: NeuralMarketSynthesis, opts: SanitizeOptions = {}): NeuralMarketSynthesis {
  ...
  return {
    ...
    healthometer: {
      ...
      categoryEvaluation: synthesis.healthometer.categoryEvaluation
        ? {
            ...synthesis.healthometer.categoryEvaluation,
            categories: synthesis.healthometer.categoryEvaluation.categories.map((c) => ({
              ...c,
              label: applyComplianceCopyFilter(c.label, level),
            })),
            explanations: synthesis.healthometer.categoryEvaluation.explanations.map((e) => ({
              ...e,
              educationalSummary: applyComplianceCopyFilter(e.educationalSummary, level),
              whyThisExists: applyComplianceCopyFilter(e.whyThisExists, level),
            })),
          }
        : synthesis.healthometer.categoryEvaluation,
    },
