 ...
 *
 * Usage:
 *   const { quotes, isConnected, get } = useLiveQuotes(['BDO', 'SM']);
 *   const bdo = get('BDO'); // LiveQuote | undefined
 *
 * Protocol:
 *   Client → {"type":"subscribe", "symbols":["BDO","SM"]}
 *   Client → {"type":"unsubscribe", "symbols":["ICT"]}
 *   Server → {"symbol":"BDO", "price":145.5, "bid":145.0, "ask":146.0, "volume":1234567, "timestamp":"..."}
 */
