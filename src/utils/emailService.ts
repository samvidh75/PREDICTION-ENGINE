        ...
        htmlContent: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; border-radius: 8px; margin: 20px 0; text-align: center;">
              ...
              <p style="margin: 10px 0; font-size: 14px;">That's about ₱10 a day for enterprise-grade analysis</p>
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f8f9fa; padding: 16px; border-radius: 8px; margin: 16px 0;">
              ...
              <p style="font-size: 14px; line-height: 1.6; margin: 0;">
                Check your dashboard for this week's live PSEi move, sector performance, and net foreign flow — real numbers, updated as the market trades.
              </p>
            </div>
