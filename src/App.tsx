...
function getPageKeyFromUrl(): PageKey {
  ...
  try {
    ...
    if (raw === "daily-feed") return "daily-feed";
    if (raw === "portfolio-doctor") return "portfolio-doctor";
  ...
  const mainView = useMemo(() => {
    ...
    return (
      <AppLayout>
        ...
        {activePageKey === "compare" && <StockCompare />}
        {activePageKey === "journal" && <PredictionJournalPage />}
        {activePageKey === "trust" && <TrustCentrePage />}
        {activePageKey === "workspace" && <WorkspacePage />}
        {activePageKey === "daily-feed" && <DailyFeed />}
        {activePageKey === "portfolio-doctor" && <PortfolioDoctor />}
