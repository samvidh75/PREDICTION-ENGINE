...
type PublicRoute = "home" | "scanner" | "stock" | "watchlist" | "compare" | "login";
...
function readRoute(): { page: PublicRoute; symbol: string } {
  ...
  const page: PublicRoute = requested === "landing" ? "home" : ["home","scanner","stock","watchlist","compare","login"].includes(requested) ? requested as PublicRoute : "home";
