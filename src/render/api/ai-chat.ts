...
const STOCK_KNOWLEDGE_BASE: Record<string, string> = {
  'pe ratio': `P/E Ratio = Price per share ÷ Earnings per share. Shows how much investors pay per peso of earnings.
...
export async function aiChatHandler(
  ...
  try {
    ...
    reply.send({
      response: `Ask about: P/E ratio, ROE, Debt/Equity ratio, Dividend strategy, Growth metrics, or Valuation methods. I can help you analyze PSE stocks!`,
      confidence: 0.8,
      source: 'server',
    } as ChatResponse);
  } catch (error) {
