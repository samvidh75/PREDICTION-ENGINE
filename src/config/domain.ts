...
export const SEO = {
  siteName: "Equity Lens",
  domain: APP_DOMAIN,
  origin: APP_ORIGIN,
  twitterHandle: "@EquityLensIndia",
  defaultDescription:
    "Equity Lens — AI-powered investor intelligence for the Indian stock market. Discover, analyse and track NSE/BSE equities with real-time data.",
