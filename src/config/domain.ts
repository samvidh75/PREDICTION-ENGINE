...
export const SEO = {
  ...
  domain: APP_DOMAIN,
  origin: APP_ORIGIN,
  twitterHandle: "@stockstory_ph",
  defaultDescription:
    "STOCKEX — AI-powered investor intelligence for the Philippine Stock Exchange (PSE). Discover, analyse and track PSE equities with real-time data.",
