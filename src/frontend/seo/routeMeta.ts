...
export function resolveRouteMeta(
  ...
  if (p === "/scanner") {
    return {
      ...
      description:
        "Screen and filter PSE stocks using research-driven criteria. Quality, valuation, growth, momentum, and risk scores.",
      canonical: "/scanner",
      ogImage: "/og-image.png",
    };
  }
  ...
  if (p === "/sectors") {
    return {
      title: "Sector Research — PSE Stock Sectors | STOCKEX",
      description:
        "Research-driven analysis of PSE stock sectors. Scorecards, trends, and peer comparisons by sector.",
      canonical: "/sectors",
    };
  }
