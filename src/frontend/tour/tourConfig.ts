...
const WELCOME_TOUR: TourConfig = {
  ...
  dismissible: true,
  steps: [
    { target: "#hero-section", title: "Research-Driven Analysis", content: "StockEX helps you research PSE equities with structured scorecards, not tips or recommendations.", placement: "bottom" },
