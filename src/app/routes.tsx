...
const PseTradingDashboard = lazy(() => import("../components/PseTradingDashboard"));
  ...
  return (
    <Suspense fallback={<RouteFallback />}>
      <Routes>
        ...
        <Route path="/predictions" element={<Suspense fallback={<RouteFallback />}><PublicLayout><PredictionPage /></PublicLayout></Suspense>} />
        <Route path="/live-market" element={<Suspense fallback={<RouteFallback />}><PublicLayout><LiveMarketPage /></PublicLayout></Suspense>} />
        <Route path="/pse-market" element={<Suspense fallback={<RouteFallback />}><PublicLayout><PseTradingDashboard /></PublicLayout></Suspense>} />
