...
export interface SectorIntelligenceProfile {
  ...
  /** PSE market specific context */
  philippinesContext: PhilippinesSectorContext;
...
export interface PhilippinesSectorContext {
  /** Government focus areas (infrastructure, digitization) */
  ...
  /** Relevant regulations (SEC, BSP, etc.) */
