...
export interface CalibrationConfig {
  ...
  /** Market-cap bucket thresholds (PHP millions) */
...
export interface MarketCapBucket {
  ...
  label: string;
  /** Min market cap in millions PHP */
  minCap: number;
  /** Max market cap in millions PHP */
  maxCap: number;
...
export interface RiskCalibration {
  /** Default risk-free rate (Philippines 10Y bond yield) */
  riskFreeRate: number;
  /** Equity risk premium for Philippines */
...
export interface ValuationCalibration {
  /** DCF default growth rate for Philippines */
...
/** Default calibration for PSE equities */
