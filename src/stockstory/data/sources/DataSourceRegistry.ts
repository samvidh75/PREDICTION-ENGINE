  ...
  private registerBuiltInSources(): void {
    const builtIn: DataSource[] = [
      ...
      },
      {
        ...
        description: 'Public financial data for Philippine companies, including ratios, P&L, balance sheet, cash flow, and shareholding',
      ...
      },
      {
        ...
        description: 'RBI Database on Philippine Economy for macro and rates data',
      ...
      },
      {
        ...
        description: 'Regulatory filings from SEC (India) — annual reports, disclosures',
        requiresAuth: false,
        coverageScope: 'india',
        lastVerified: null,
      },
