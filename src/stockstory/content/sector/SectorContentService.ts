...
const SECTOR_CONTENT: Record<string, SectorContent> = {
  ...
  fmcg: {
    ...
    overview: "India's FMCG sector is characterised by strong brand loyalty, extensive distribution networks, and steady consumption growth. Rural and urban markets both contribute significantly.",
