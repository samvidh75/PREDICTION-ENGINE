export const METHODOLOGY_SECTIONS = [
  {
    ...
    content: "StockStory India uses a comprehensive, multi-factor framework to evaluate and score Indian equities based on fundamental, technical, and market data.",
    subsections: [
      {
        title: "Data Sources",
        content: "We aggregate data from Indian stock exchanges (NSE, BSE), regulatory filings, broker APIs, and verified financial databases.",
      },
      {
