export const METHODOLOGY_SECTIONS = [
  {
    ...
    content: "StockEX Philippines uses a comprehensive, multi-factor framework to evaluate and score PSX equities based on fundamental, technical, and market data.",
    subsections: [
      {
        title: "Data Sources",
