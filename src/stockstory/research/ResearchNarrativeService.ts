...
export class ResearchNarrativeService {
  ...
  generateFullNarrative(input: StockStoryResearchInput): StockStoryNarrativeOutput {
    return {
      ...
      methodologyNote: 'This research summary is generated by StockStory\'s deterministic analytical engine. Scores are derived from financial fundamentals, technical indicators, and sector-relative percentile rankings. Research methodology is documented on the Methodology page.',
