...
export function buildResearchReport(
  ...
  return {
    ...
    sections,
    disclaimer: "This research report is for informational purposes only. It does not constitute investment advice. StockEX Philippines does not provide buy/sell recommendations. Consult a PSE-listed investment advisor before making investment decisions.",
  };
}
