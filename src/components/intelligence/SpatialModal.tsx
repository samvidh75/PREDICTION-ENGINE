    ...
    >
      <div
        ...
        className={`
          ...
          shadow-[0_24px_80px_rgba(15,23,42,0.6),0_8px_24px_rgba(15,23,42,0.4),inset_0_1px_0_rgba(15,23,42,0.06)]
      ...
      >
        ...
        <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-[var(--color-border-light)] bg-[var(--color-surface)] px-6 py-5">
          <div className="min-w-0 flex-1">
            {title && (
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]" id="spatial-modal-title">{title}</h2>
            )}
            {subtitle && (
