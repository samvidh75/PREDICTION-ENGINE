      ...
      >
        <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-[rgba(148,163,184,0.12)] bg-[var(--color-surface)] px-6 py-5">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-[rgba(15,23,42,0.05)] text-[var(--color-text-secondary)] hover:bg-[rgba(15,23,42,0.10)] hover:text-[var(--color-text-primary)] transition-colors"
            aria-label="Close"
          >
            <X className="h-4 w-4" />
          </button>
