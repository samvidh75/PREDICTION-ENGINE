 ...
 *
 * StockStory India does NOT place trades, charge brokerage, or handle funds.
 */
    ...
    <div onClick={onClose} style={overlayStyle}>
      <div onClick={(e) => e.stopPropagation()} style={modalStyle}>
        ...
        >
          ...
          />
          <span>
            I understand that StockStory India provides only research analysis and does not execute trades.
