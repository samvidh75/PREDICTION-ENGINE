...
const CATEGORIES: CategoryDef[] = [
  {
    ...
    hint: "Rate-setting context as a conditioning variable.",
  },
  {
    id: "inflation_rates",
...
export default function MarketStructuredNewsFeed({
  ...
  const itemsByCategory = useMemo(() => {
    ...
    const bodyPrefix = "Market context as learning tone (no headlines). ";
    const safeNoCert = "We keep it as context, not certainty.";
    ...
    <section className={wrapperClass}>
      <div className="mx-auto max-w-[1680px]">
        <div className="mb-6 flex items-end justify-between gap-4">
          ...
          >
            <div className="text-[11px] uppercase tracking-[0.18em] text-white/65">Context framing</div>
            <div className="mt-1 text-[11px] uppercase tracking-[0.18em] text-white/45">Learning notes</div>
          </div>
        </div>
