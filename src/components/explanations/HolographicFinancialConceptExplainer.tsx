  ...
  switch (concept) {
    case "marketCap":
      return beginner
        ? {
            ...
            contextNote: "Positioning note for calm learning framing.",
          }
        : {
            ...
            contextNote: "Calm contextual rail with bounded variance.",
          };
    ...
    case "pe":
      return beginner
        ? {
            ...
            contextNote: "Valuation feeling as context, not advice.",
          }
        : {
    ...
    case "liquidity":
      return beginner
        ? {
            ...
            contextNote: "Interpretation texture and pacing, as a learning cue.",
          }
        : {
    ...
    case "volatility":
      return beginner
        ? {
            ...
            contextNote: "Sensitivity and pacing, shown as calm learning cues.",
          }
        : {
            ...
            contextNote: "Calm interpretation overlay.",
          };
    ...
    case "debtRatio":
      return beginner
        ? {
            ...
            contextNote: "Relative tension context for learning.",
          }
        : {
            ...
            contextNote: "Calm learning framing.",
          };
    ...
    default: {
      ...
      return {
        ...
        contextNote: "Calm learning context.",
      };
    }
  }
}
