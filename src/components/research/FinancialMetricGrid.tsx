  ...
  if (groups.length === 0) {
    return (
      <div className="rounded-xl border border-[rgba(148,163,184,0.12)] bg-[rgba(255,255,255,0.025)] p-4">
        <p className="text-xs text-[var(--color-text-secondary)]">Financial data is limited for this company.</p>
      </div>
    );
  }
      ...
      {groups.map((group) => (
        <div key={group.title} className="rounded-xl border border-[rgba(148,163,184,0.12)] bg-[rgba(255,255,255,0.025)] p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-[11px] font-bold uppercase tracking-wider text-[var(--color-text-secondary)]">{group.title}</h3>
          </div>
