 ...
 * Displays dividend income, withholding tax, and payout notes
 */
            ...
            <>
              ...
              <div style={{ marginBottom: '16px', padding: '12px', backgroundColor: 'white', borderRadius: '6px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', fontSize: '12px' }}>
                  ...
                  <div>
                    <div style={{ color: '#666' }}>Withholding Tax (10%)</div>
                    <div style={{ fontWeight: 'bold', fontSize: '14px', color: '#ea4335' }}>
                      ₱{stats.totalWithholdingTax.toLocaleString('en-PH')}
                    </div>
                  </div>
                  <div>
                    <div style={{ color: '#666' }}>Net After Withholding Tax</div>
              ...
              <div style={{ marginBottom: '12px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  ...
                  >
                    📌 Cash dividends are subject to a flat 10% final withholding tax, deducted at source — no further individual income tax applies to this income.
                  </div>
                  ...
                  >
                    💰 Your total dividend income (₱{stats.finallyTaxedIncome.toLocaleString('en-PH')}) is already finally taxed at source — it isn't added to your other income for filing.
                  </div>
                </div>
              </div>
              ...
              <div style={{ marginBottom: '12px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px', fontSize: '11px' }}>
                  ...
                  >
                    <div style={{ color: '#666', marginBottom: '4px' }}>Effective Yield (After Withholding Tax)</div>
                    <div style={{ fontWeight: 'bold', fontSize: '13px' }}>
              ...
              >
                ⚠️ <strong>Tax Disclaimer:</strong> Dividend information is for educational purposes. For tax planning, consult a CPA. Withholding tax rates may change based on BIR rules.
              </div>
            </>
          )}
        </div>
