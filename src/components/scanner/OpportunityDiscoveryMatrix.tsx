...
export default function OpportunityDiscoveryMatrix({
  ...
  const matrixItems = useMemo(() => {
    ...
    const liquidity = synthesis.liquidityIntelligenceCore.replace(/institutional/gi, "large-investor");
    ...
    return [
      ...
      { key: "inst", title: "Large-investor participation", body: institutional.replace(/institutional/gi, "large-investor"), glow: glows.cyanGlow },
