  ...
  switch (health) {
    case "STRUCTURALLY_HEALTHY":
      return {
        ...
        caution: "interpretation stays bounded (learning context)",
      };
...
function pickCoreMission(args: {
  ...
  return [
    ...
    `Interpretation note: ${tone.caution}.`,
  ].join("\n");
}
    ...
    <section className="relative z-[12] px-6 sm:px-[72px] pb-14">
      <div className="mx-auto max-w-[1680px]">
        <CompanyUniverseSectionHeader
          ...
          subtitle="Human and strategic, documentary-style. Leadership philosophy becomes a calm mission frame with clear interpretation boundaries."
        />
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            {dnaCards.map((c) => (
              <CompanyUniverseCard key={c.title} className="p-6">
                ...
                <div className="mt-4 text-[11px] uppercase tracking-[0.18em] text-white/45">Company intelligence context</div>
              </CompanyUniverseCard>
            ))}
          </div>
        </CompanyUniverseGrid>
