      ...
      >
        <div className="p-6 sm:p-7">
          ...
          <div className="mt-6 rounded-[22px] border border-white/10 bg-black/20 p-4">
            <div className="text-[11px] uppercase tracking-[0.18em] text-white/55">Quick note</div>
            <div className="mt-2 text-[13px] leading-[1.7] text-white/80">
              StockStory India provides company research context. Execution happens on your brokerage platform.
            </div>
          </div>
        </div>
      </div>
