...
export default function CompanyMarketStoryLayer({
  ...
  const foundersBlock = useMemo(() => {
    ...
    if (!f0) return "Founders: leadership data pending.";
  ...
  const leadershipBlock = useMemo(() => {
    ...
    if (!l0) return "Leadership: leadership data pending.";
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        <div className="lg:col-span-7">
          <CompanyUniverseCard className="p-6">
            ...
            <div className="mt-4 text-[11px] uppercase tracking-[0.18em] text-white/45">Company intelligence</div>
          </CompanyUniverseCard>
        </div>
        ...
        <div className="lg:col-span-5">
          <CompanyUniverseCard className="p-6">
            ...
            <div className="mt-4 text-[11px] uppercase tracking-[0.18em] text-white/45">Learning lens</div>
          </CompanyUniverseCard>
        </div>
      </div>
      ...
      <CompanyUniverseCard className="p-6">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
          ...
          <div className="rounded-[22px] border border-white/10 bg-black/20 p-4">
            ...
            <div className="mt-4 text-[11px] uppercase tracking-[0.18em] text-white/45">Bounded interpretation</div>
          </div>
        </div>
      </CompanyUniverseCard>
      ...
      {!beginner && (
        <CompanyUniverseCard className="p-6">
          <div className="flex items-end justify-between gap-4">
            ...
            <div className="text-[11px] uppercase tracking-[0.18em] text-white/45">Long-term lens</div>
          </div>
    ...
    <section className="relative z-[12] px-6 sm:px-[72px] pb-14">
      <div className="mx-auto max-w-[1680px]">
        <CompanyUniverseSectionHeader
          ...
          subtitle="Clear structure for what the company does, why it matters, and how to interpret it calmly."
        />
