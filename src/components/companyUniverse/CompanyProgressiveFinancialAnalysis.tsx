  ...
  const front = (
    <CompanyUniverseCard className="p-6">
      <div className="flex items-end justify-between gap-4">
        ...
        <div className="text-[11px] uppercase tracking-[0.18em] text-white/45">Learning-first lens</div>
      </div>
      ...
      <div className="mt-4 text-[12px] uppercase tracking-[0.18em] text-white/45">
        Complexity stays layered and digestible
      </div>
    </CompanyUniverseCard>
  );
  ...
  const expandedContent = (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-6">
          <CompanyUniverseCard className="p-6">
            <div className="text-[12px] uppercase tracking-[0.18em] text-white/70">Advanced valuation context</div>
      ...
      <div className="text-[12px] uppercase tracking-[0.18em] text-white/45">
        Expanded layer reveals depth, while keeping interpretation manageable
      </div>
    </div>
  );
