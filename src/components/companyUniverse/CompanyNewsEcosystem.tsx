...
export default function CompanyNewsEcosystem({
  ...
  const shown = useMemo(() => news.slice(0, beginner ? 3 : Math.min(news.length, 10)), [news, beginner]);
        ...
        <div className="mb-6 flex items-end justify-between gap-4">
          <div>
            ...
            <div className="mt-3 text-[14px] leading-[1.9] text-white/80 max-w-[86ch]">
              This feed isolates company-level updates. Broader market context belongs to the dashboard.
            </div>
          </div>

          <div className="text-[11px] uppercase tracking-[0.18em] text-white/45">
            Calm editorial updates
          </div>
        </div>
