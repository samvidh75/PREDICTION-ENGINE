...
function variantDefaults(variant: PremiumCardVariant | undefined): {
  ...
  switch (variant) {
    case "hero":
      return { baseClass: "ss-glass-2", radiusClass: "ss-radius-extra-large", paddingClass: "ss-pad-6", extraClass: "overflow-hidden" };
    case "intelligence":
      return { baseClass: "ss-glass-2", radiusClass: "ss-radius-large", paddingClass: "ss-pad-6", extraClass: "" };
    case "chart":
      return { baseClass: "ss-glass-2", radiusClass: "ss-radius-large", paddingClass: "ss-pad-5", extraClass: "overflow-hidden" };
    case "scanner":
      return { baseClass: "ss-glass-2", radiusClass: "ss-radius-large", paddingClass: "ss-pad-5", extraClass: "overflow-hidden" };
    case "pulse":
      return { baseClass: "ss-glass-2", radiusClass: "ss-radius-large", paddingClass: "ss-pad-5", extraClass: "" };
    case "ai":
      return { baseClass: "ss-glass-2", radiusClass: "ss-radius-large", paddingClass: "ss-pad-6", extraClass: "overflow-hidden" };
    case "infographic":
      return { baseClass: "ss-glass-2", radiusClass: "ss-radius-large", paddingClass: "ss-pad-6", extraClass: "" };
    case "macro":
      return { baseClass: "ss-glass-2", radiusClass: "ss-radius-large", paddingClass: "ss-pad-6", extraClass: "" };
    case "glass":
      return { baseClass: "ss-glass", radiusClass: "ss-radius-large", paddingClass: "ss-pad-6", extraClass: "" };
    case "glass2":
    default:
      return { baseClass: "ss-glass-2", radiusClass: "ss-radius-medium", paddingClass: "ss-pad-6", extraClass: "" };
  }
}
...
export default function PremiumCard(props: PremiumCardProps): JSX.Element {
  ...
  const commonProps = {
    className: `${computed.d.baseClass} ${computed.d.radiusClass} ${computed.d.paddingClass} ${computed.d.extraClass} ${
      clickable ? "ss-card-clickable ss-focus-outline text-left cursor-pointer" : ""
    } ${className ?? ""}`.trim(),
