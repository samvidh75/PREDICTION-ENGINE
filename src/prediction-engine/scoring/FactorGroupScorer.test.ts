...
describe('computeCompositeScore', () => {
  it('handles all-null factor scores gracefully', () => {
    const factorScores = [
      ...
      { group: 'stability' as const, value: null, availability: 0, confidence: 0, featureCount: 4, availableFeatureCount: 0, missingFeatures: ['beta'], reason: '' },
  ...
  it('risk dampening works correctly', () => {
    const base = [
      ...
      { group: 'stability' as const, value: 50, availability: 100, confidence: 80, featureCount: 4, availableFeatureCount: 4, missingFeatures: [], reason: '' },
