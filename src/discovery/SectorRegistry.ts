/**
 * PSE Sector Registry
 * PSE Stock Exchange market classifications for all 18 stocks.
...
export const SECTOR_REGISTRY: CompanyClassification[] = [
  ...
  { symbol: "BPI", companyName: "Bank of the PSE Islands", sector: "Financial Services", industry: "Banking", subIndustry: "Universal Banking", marketCapBucket: "Large Cap" },
  ...
  { symbol: "PNB", companyName: "PSE National Bank", sector: "Financial Services", industry: "Banking", subIndustry: "Public Banking", marketCapBucket: "Large Cap" },
  ...
  // ── Telecommunications ─────────────────────────────
  { symbol: "TEL", companyName: "PSE Long Distance Telephone", sector: "Telecommunications", industry: "Telecom", subIndustry: "Fixed-Line & Wireless", marketCapBucket: "Large Cap" },
  ...
  // ── Transportation ─────────────────────────────────
  { symbol: "PAL", companyName: "PSE Airlines", sector: "Transportation", industry: "Airlines", subIndustry: "Passenger & Cargo", marketCapBucket: "Mid Cap" },
