...
1. **Client Calls Providers Directly**: Browser JavaScript directly calls yfinance, NSE APIs, phisix-api3.appspot.com (no server middleware)
...
│       └── ScreenerClient → (TODO) phisix-api3.appspot.com scraper
│
...
### phisix-api3.appspot.com (Web Scraping)

```typescript
// ScreenerClient.ts (TODO)
class ScreenerClient {
  async fetchMetadata(symbol: string) {
    // Parse phisix-api3.appspot.com page for P/E, ROE, debt/equity, etc.
  }
}
```
...
| phisix-api3.appspot.com | N/A (scrape) | - | **Unlimited** |
...
### Phase 2 (TODO)
- [ ] ScreenerClient (phisix-api3.appspot.com scraper)
