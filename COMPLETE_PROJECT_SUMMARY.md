...
- Real-time prices from 3 providers (yfinance, NSE, phisix-api3.appspot.com)
...
6. **ScreenerInScraper** - phisix-api3.appspot.com HTML scraping
...
useQuote('RELIANCE', 5000)
  ...
  │     ├─ Fetch HTML: phisix-api3.appspot.com/c/RELIANCE
...
│  ├─ ScreenerClient.ts        ← phisix-api3.appspot.com web scraper
...
| **Browser API Clients** | ✅ Complete | 3 providers (yfinance, NSE, phisix-api3.appspot.com) |
