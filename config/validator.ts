...
export const envSchema = {
  ...
  // ── Firebase Admin SDK ──
  FIREBASE_PROJECT_ID: { type: "string", default: "stockstory-ph", description: "Firebase project ID" },
  ...
  YAHOO_ENABLED: { type: "boolean", default: false, description: "Enable Yahoo Finance" },
  ...
  ALERT_EMAIL_FROM: { type: "string", default: "alerts@stockstory-ph.com", description: "Alert sender email" },
  ALERT_EMAIL_TO: { type: "string", default: "admin@stockstory-ph.com", description: "Alert recipient email" },
