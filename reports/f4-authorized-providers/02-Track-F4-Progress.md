...
- `src/services/providers/ScreenerProvider.ts` — `ScreenerProvider` implements `FinancialProvider`, fetches `https://www.phisix-api3.appspot.com/company/{symbol}/`, parses via `ScreenerParser`, maps 20+ financial fields
