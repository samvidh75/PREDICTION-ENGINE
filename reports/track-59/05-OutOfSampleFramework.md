...
## Temporal Splits
- **Train** (2019-2022): Factor discovery and weight calibration
- **Validation** (2023): Hyperparameter tuning, no weight changes
- **Test** (2024-2025): Final evaluation, results locked, no further tuning
...
## Current Issue
TRACK-48/51 used full 2019-2025 data for factor discovery AND validation. This overfits weights to in-sample data.
