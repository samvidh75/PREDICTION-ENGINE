...
- `generate-deliverables.ts:41` has `marketCapInr / 100_000_00` — **this is a bug**: the source is already in millions PHP, dividing by 100_000_00 would destroy the value. But this path only affects F1 batch script, not daily pipeline.
