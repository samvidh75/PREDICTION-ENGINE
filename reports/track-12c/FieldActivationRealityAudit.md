...
### Discrepancies
- `generate-deliverables.ts:41` has `marketCapInr / 100_000_00` — this is unnecessary since `market_cap` is already in millions PHP. Over-division would produce tiny values.
