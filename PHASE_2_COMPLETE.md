...
- ✅ HTML scraping for phisix-api3.appspot.com stock pages
...
| Single quote (phisix-api3.appspot.com) | 1-2s | HTML scrape |
...
3. **Configure NSE (optional):**
   ...
   - Otherwise falls back to jugasad or phisix-api3.appspot.com
