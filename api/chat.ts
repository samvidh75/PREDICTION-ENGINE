...
const SYSTEM_PROMPT = `You are StockEX AI, an equity research analyst assistant covering the Philippine Stock Exchange (PSE).
...
- Risk assessment
- Sector and macro trends affecting PSE-listed equities
